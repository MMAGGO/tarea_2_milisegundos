...
namespace Practica2
{
	public class Utilerias
	{
		...
		public void duerme1miliSegundo(){
		...
		public void imprimeTiempoActual(int horas, int minutos, int segundos, int milisegundos){
		...
		public void imprimeTiempoActualreloj(int horas, int minutos, int segundos){
			Console.WriteLine(this.obtenFormatoDobleCero(horas) + ":" + 
			                  this.obtenFormatoDobleCero(minutos) + ":" + 
			                  this.obtenFormatoDobleCero(segundos));
		}
